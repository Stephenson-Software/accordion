...
import com.accordion.dto.LoginRequest;
import com.accordion.dto.RegisterRequest;
import com.accordion.model.User;
import com.accordion.security.JwtUtil;
import com.accordion.service.UserService;
...
@WebMvcTest(controllers = UserController.class,
    excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, 
        classes = {com.accordion.config.SecurityConfig.class, 
                   com.accordion.security.JwtAuthenticationFilter.class,
                   com.accordion.security.WebSocketAuthInterceptor.class}))
